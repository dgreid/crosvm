...
use kvm_sys::{KVM_ARM_PREFERRED_TARGET, KVM_ARM_VCPU_INIT, KVM_CAP_ONE_REG, KVM_SET_ONE_REG};

use kvm_sys::{
    KVM_CHECK_EXTENSION, KVM_CREATE_DEVICE, KVM_CREATE_IRQCHIP, KVM_CREATE_VCPU, KVM_CREATE_VM,
    KVM_ENABLE_CAP, KVM_GET_DIRTY_LOG, KVM_GET_VCPU_MMAP_SIZE, KVM_IOEVENTFD, KVM_IRQFD,
    KVM_IRQ_LINE, KVM_KVMCLOCK_CTRL, KVM_RUN, KVM_SET_SIGNAL_MASK, KVM_SET_USER_MEMORY_REGION,
    KVM_SIGNAL_MSI,
};

#[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
use kvm_sys::{
    KVM_CREATE_PIT2, KVM_GET_CLOCK, KVM_GET_DEBUGREGS, KVM_GET_EMULATED_CPUID, KVM_GET_FPU,
    KVM_GET_IRQCHIP, KVM_GET_LAPIC, KVM_GET_MP_STATE, KVM_GET_MSRS, KVM_GET_MSR_INDEX_LIST,
    KVM_GET_PIT2, KVM_GET_REGS, KVM_GET_SREGS, KVM_GET_SUPPORTED_CPUID, KVM_GET_VCPU_EVENTS,
    KVM_GET_XCRS, KVM_INTERRUPT, KVM_SET_CLOCK, KVM_SET_CPUID2, KVM_SET_DEBUGREGS, KVM_SET_FPU,
    KVM_SET_GSI_ROUTING, KVM_SET_IDENTITY_MAP_ADDR, KVM_SET_IRQCHIP, KVM_SET_LAPIC,
    KVM_SET_MP_STATE, KVM_SET_MSRS, KVM_SET_PIT2, KVM_SET_REGS, KVM_SET_SREGS, KVM_SET_TSS_ADDR,
    KVM_SET_VCPU_EVENTS, KVM_SET_XCRS,
};
