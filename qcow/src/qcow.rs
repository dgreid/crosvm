...
impl QcowFile {
    ...
    fn find_avail_clusters(&mut self) -> Result<()> {
        ...
        let total_clusters = file_size / cluster_size - first_cluster;
        let num_clusters = min(MAX_FREE_CLUSTER_SCAN, total_clusters);
        ...
        self.next_cluster_avail_scan = end_cluster;
...
mod tests {
    ...
    // Another test case found by clusterfuzz to allocate excessive memory.
    fn test_fuzz_header() -> Vec<u8> {
        vec![
            0x51, 0x46, 0x49, 0xfb, //
            0x00, 0x00, 0x00, 0x03, //
            ...
            0xad, 0x2c, 0x60, 0x00, //
            0x00, 0x00, 0x00, 0x09, //
            0x00, 0x00, 0x00, 0x04, 0x08, 0x00, 0xc2, 0x00, //
            0x0b, 0x00, 0x00, 0x00, // // //
            0x00, 0x00, 0x00, 0x00, //
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //
            ...
            0x00, 0x00, 0x00, 0x04, //
            0x00, 0x00, 0xfb, 0xee, //
            ,
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x5d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    #[test]
    fn test_header_fuzz_file() {
        let header = test_fuzz_header();
        with_basic_file(&header, |disk_file: File| {
            QcowFile::from(disk_file).expect("Failed to create file.");
        });
    }
