/*
 * automatically generated by bindgen 0.59.2
 * Kernel with AIA patches based on 5.16
 * $ cd /path/to/kernel/
...
pub const KVM_REG_RISCV_CSR_GENERAL_FIRST: u32 = 0;
...
fn bindgen_test_layout_kvm_riscv_csr() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_riscv_csr>())).siselect as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_riscv_csr),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_riscv_csr>())).siprio1 as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_riscv_csr),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_riscv_csr>())).siprio2 as *const _ as usize },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_riscv_csr),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_riscv_csr>())).sieh as *const _ as usize },
        104usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_riscv_csr),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_riscv_csr>())).siph as *const _ as usize },
        112usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_riscv_csr),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_riscv_csr>())).siprio1h as *const _ as usize },
        120usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_riscv_csr),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_riscv_csr>())).siprio2h as *const _ as usize },
        128usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_riscv_csr),
