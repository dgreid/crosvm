...
#[cfg(feature = "pci-hotplug")]
fn handle_hotplug_block_command(
...
#[cfg(feature = "pci-hotplug")]
fn handle_hotplug_vhost_user_block_command(
...
#[cfg(feature = "pci-hotplug")]
fn handle_hotplug_vhost_user_block_add(
    linux: &mut RunnableLinuxVm,
    sys_allocator: &mut SystemAllocator,
    add_control_tube: &mut impl FnMut(AnyControlTube),
    hotplug_manager: &mut PciHotPlugManager,
...
#[cfg(feature = "pci-hotplug")]
fn add_hotplug_vhost_user_block(
    linux: &mut RunnableLinuxVm,
    sys_allocator: &mut SystemAllocator,
    add_control_tube: &mut impl FnMut(AnyControlTube),
    hotplug_manager: &mut PciHotPlugManager,
